...
('Kenji Yamamoto', '1995-01-01', 'male', 73.5, 'Black (DAN 1)', NULL, NULL, 'Tokyo', 'Kanto', '123 Sakura Street, Tokyo', '+81-3-1234-5678', 'kenji.yamamoto@example.com', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Maria Rodriguez', '2002-01-01', 'female', 63.0, 'Blue', NULL, NULL, 'Madrid', 'Community of Madrid', '456 Gran Via, Madrid', '+34-91-234-5678', 'maria.rodriguez@example.com', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('David Kim', '1999-01-01', 'male', 66.8, 'Brown', NULL, NULL, 'Seoul', 'Seoul', '654 Gangnam-gu, Seoul', '+82-2-1234-5678', 'david.kim@example.com', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Emma Watson', '2006-01-01', 'female', 52.0, 'Yellow', NULL, NULL, 'London', 'Greater London', '987 Baker Street, London', '+44-20-1234-5678', 'emma.watson@example.com', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('Hiroshi Tanahashi', '1985-01-01', 'male', 95.0, 'Black (DAN 4)', NULL, NULL, 'Nagoya', 'Chubu', '852 Sakae, Nagoya', '+81-52-1234-5678', 'hiroshi.tanahashi@example.com', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
